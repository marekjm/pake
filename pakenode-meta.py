...
options.add(short='g', long='get', conflicts=['set', 'rm', 'print'])
options.add(short='s', long='set', conflicts=['get', 'rm', 'print'])
options.add(long='rm', conflicts=['get', 'set', 'print'])
options.add(long='print', conflicts=['get', 'set', 'rm'])
options.add(long='missing', conflicts=['get', 'set', 'rm'])
